...
class FunctionalRealtimeTransducer(object):
    """Completely specified deterministic real-time transducer
    
    Based on Moore implementation in https://github.com/hemangsk/automata-python
    Adapted to use lists for the output
    """
